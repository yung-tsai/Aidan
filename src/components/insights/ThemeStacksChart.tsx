  ...
  return (
    <div className="space-y-2 sm:space-y-3">
      {mockThemes.map((theme, index) => {
        ...
        return (
          <div key={theme.name} className="flex items-center gap-2 sm:gap-3">
            <span className="font-ibm text-[10px] sm:text-xs text-insights-gray-mid w-14 sm:w-20 flex-shrink-0">
              {theme.name}
            </span>
            <div className="flex-1 h-4 sm:h-[18px] bg-insights-hover relative">
              <div 
            ...
            <span className="font-ibm text-[10px] sm:text-xs text-insights-gray-mid w-8 sm:w-10 text-right">
              {theme.percentage}%
            </span>
          </div>
        );
      ...
      <a 
        href="#" 
        className="inline-block font-ibm text-xs sm:text-sm text-insights-gray-mid hover:text-insights-dark underline mt-2 transition-colors"
      >
