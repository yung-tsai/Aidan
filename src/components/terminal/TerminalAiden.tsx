  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ...
        className="terminal-box min-h-[300px] max-h-[400px] overflow-y-auto overflow-x-hidden p-4 terminal-scrollbar"
      >
        {isBooting ? (
          <div className="font-vt323 text-lg text-terminal-glow terminal-glow">
            <p>Initializing AIDEN...</p>
            <p className="mt-2">
              Loading neural networks... <span className="boot-cursor">█</span>
            </p>
      ...
      {/* Status Bar */}
      <div className="terminal-box px-4 py-2 flex items-center justify-between">
      ...
      {/* Input Area */}
      <div className="flex items-stretch terminal-box">
        <div className="flex-1 flex items-center px-4 py-3">
          ...
          <input
            ...
            className="flex-1 font-ibm text-sm terminal-input placeholder:text-terminal-muted bg-transparent outline-none text-terminal-text"
          />
          {showCursor && !input && <span className="terminal-cursor">█</span>}
        </div>

        <button
          onClick={handleSendAndNavigate}
          disabled={isLoading}
          className="px-4 flex items-center justify-center border-l border-terminal-border hover:bg-terminal-accent/20 transition-colors"
        >
